...
interface OrderbookAbiInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'withdraw_protocol_fee', values: [IdentityInput]): Uint8Array;
  ...
  decodeFunctionData(functionFragment: 'withdraw_protocol_fee', data: BytesLike): DecodedValue;
  ...
  decodeFunctionData(functionFragment: 'protocol_fee_amount', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'total_protocol_fee', data: BytesLike): DecodedValue;
