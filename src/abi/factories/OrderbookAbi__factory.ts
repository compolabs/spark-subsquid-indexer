    ...
    },
    {
      ...
      "attributes": [
        ...
        },
        {
          "name": "doc-comment",
          "arguments": [
            " @param None - The function doesnt take any input parameters; it uses context information."
          ]
        },
        {
          "name": "doc-comment",
      ...
      "attributes": [
        {
          "name": "doc-comment",
          "arguments": [
            " @notice Withdraws a specified amount of a given asset from the callers account."
          ]
        },
        {
          "name": "doc-comment",
